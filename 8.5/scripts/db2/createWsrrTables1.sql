...
GRANT SELECT,INSERT,UPDATE,DELETE ON SUBJECT TO USER WSRRUSER; 
GRANT SELECT,INSERT,UPDATE,DELETE ON PREDICATE TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON OBJECT TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON GRAPH TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON STATEMENT TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON GSTATEMENT TO USER WSRRUSER;
GRANT SELECT ON SVC_STATEMENT TO USER WSRRUSER;
GRANT UPDATE ON MOD_LOCK TO USER WSRRUSER;
