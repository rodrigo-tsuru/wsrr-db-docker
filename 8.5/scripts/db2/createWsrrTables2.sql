...
GRANT SELECT,INSERT,UPDATE,DELETE ON SR_WMB_POLICY TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON SR_VALDTRPOLICY TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON SR_ENTITYACTION TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON SR_ASSOCIATED TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON SR_ANALYTICS TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON SR_ASSERTION TO USER WSRRUSER;

GRANT SELECT,INSERT,UPDATE,DELETE ON WSRRTASK TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON WSRRTREG TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON WSRRLMGR TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON WSRRLMPR TO USER WSRRUSER;

GRANT SELECT,INSERT,UPDATE,DELETE ON UPGRADESTATUSRECORD TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON UPGRADEEXCEPTIONS TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON UPGRADEOBJECTHISTORY TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON UPGRADEOBJECTSTATUS TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON UPGRADECOMPONENTS TO USER WSRRUSER;

GRANT SELECT,INSERT,UPDATE,DELETE,ALTER ON CRE_LARGE_CDATA TO USER WSRRUSER; 
GRANT SELECT,INSERT,UPDATE,DELETE ON CRE_PAGE TO USER WSRRUSER; 
GRANT SELECT,INSERT,UPDATE,DELETE,ALTER ON CRE_STATE_ITEM TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON CRE_STATE_SET TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON CRE_WIDGET_INSTANCE TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON CRE_WIDGET_INSTANCE_CRE_WIRE TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE,ALTER ON CRE_WIRE TO USER WSRRUSER;

GRANT SELECT,INSERT,UPDATE,DELETE,ALTER ON UIUSER          TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON USERVIEWPERM   TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON DEFAULTPERM   TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON UISTATUSFLAG TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON UIUSERSTORAGE TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON USERVIEWPERM_VW TO USER WSRRUSER;
GRANT SELECT,INSERT,UPDATE,DELETE ON DEFAULTPERM_VW TO USER WSRRUSER;

CREATE TABLE VERIFY ( VERIFY VARCHAR(60) ) IN USERSPACE1;
GRANT SELECT,INSERT,DELETE ON VERIFY TO USER WSRRUSER;
